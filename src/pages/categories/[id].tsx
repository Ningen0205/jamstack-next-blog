...
import { Category, Content, GetCategoryListResponse, GetContentListResponse } from "../../types";

const Detail: NextPage<{ category: Category; contents: Content[] }> = ({ category, contents }) => {
  return (
    <div>
      <div>{category.id}</div>
